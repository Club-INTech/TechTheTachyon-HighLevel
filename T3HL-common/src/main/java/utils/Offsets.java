...
public enum Offsets implements ConfigInfo {
    ...
    ACCELERATEUR_Y_RECALAGE_JAUNE(100),
    ACCELERATEUR_Y_RECALAGE_VIOLET(100),
    ACCELERATEUR_THETA_RECALAGE_JAUNE(0.1),
    ACCELERATEUR_THETA_RECALAGE_VIOLET(0.1),
    ACCELERATEUR_THETA_RECALAGE_JAUNE_COTE_2(0.1),
    ACCELERATEUR_THETA_RECALAGE_VIOLET_COTE_2(0.1),
    ...
    DECALAGE_GOLD_JAUNE(20),
    DECALAGE_GOLD_VIOLET(20),
    ;
