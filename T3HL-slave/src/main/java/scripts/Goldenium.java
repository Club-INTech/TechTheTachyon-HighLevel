...
public class Goldenium extends Script {
    ...
    public void execute(Integer version) {
        ...
        robot.useActuator(ActuatorsOrder.DESACTIVE_LA_POMPE_DU_SECONDAIRE); //Necessaire ?
    ...
    public void finalize(Exception e) {
        ...
        robot.useActuator(ActuatorsOrder.DESACTIVE_ELECTROVANNE_DU_SECONDAIRE);//Necessaire ?
    }
