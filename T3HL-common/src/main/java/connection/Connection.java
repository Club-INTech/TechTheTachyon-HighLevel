...
public enum Connection {
    ...
    LL_MASTER_SIMULATEUR(ConfigData.LOCALHOST, ConfigData.LL_MASTER_SIMULATEUR, SocketClientInterface.class),
    HL_SLAVE_SIMULATEUR(ConfigData.LOCALHOST, ConfigData.HL_SLAVE_SIMULATEUR, SocketClientInterface.class),
    ;
