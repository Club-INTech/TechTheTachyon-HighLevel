...
public enum ActuatorsOrder implements Order {
    ...
    TEST_PALET_ATTRAPÉ_EN_FONCTION_DU_COUPLE_DU_SECONDAIRE("torqueBras sec"),
    ...
    /**
     * Utilisé pour tester tous les positions au hasard
     */
    public static final ActuatorsOrder ARM_ORDERS[] = {
            ENVOIE_LE_BRAS_DROIT_A_LA_POSITION_ASCENSEUR, ENVOIE_LE_BRAS_GAUCHE_A_LA_POSITION_ASCENSEUR,
            ENVOIE_LE_BRAS_DROIT_A_LA_POSITION_DISTRIBUTEUR, ENVOIE_LE_BRAS_GAUCHE_A_LA_POSITION_DISTRIBUTEUR,
            ENVOIE_LE_BRAS_DROIT_A_LA_POSITION_SOL, ENVOIE_LE_BRAS_GAUCHE_A_LA_POSITION_SOL,
            ENVOIE_LE_BRAS_DROIT_A_LA_POSITION_ASCENSEUR, ENVOIE_LE_BRAS_GAUCHE_A_LA_POSITION_ASCENSEUR,
            ENVOIE_LE_BRAS_DROIT_A_LA_POSITION_ACCELERATEUR, ENVOIE_LE_BRAS_GAUCHE_A_LA_POSITION_ACCELERATEUR,
            ENVOIE_LE_BRAS_DROIT_A_LA_POSITION_GOLDONIUM, ENVOIE_LE_BRAS_GAUCHE_A_LA_POSITION_GOLDONIUM,
            ENVOIE_LE_BRAS_DROIT_A_LA_POSITION_BALANCE, ENVOIE_LE_BRAS_GAUCHE_A_LA_POSITION_BALANCE,
            ENVOIE_LE_BRAS_DROIT_A_LA_POSITION_RECULE, ENVOIE_LE_BRAS_GAUCHE_A_LA_POSITION_RECULE,
            POUSSE_LE_PALET_BRAS_DROIT, POUSSE_LE_PALET_BRAS_GAUCHE,
