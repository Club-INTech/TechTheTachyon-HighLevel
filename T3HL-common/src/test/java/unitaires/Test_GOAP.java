...
public class Test_GOAP {
    ...
    public void finiteStateMachine() {
        ...
        Map<String, Object> goalState = new HashMap<>();
        goalState.put("make firewood", true);
        EnvironmentInfo goal = new EnvironmentInfo(xyo, goalState);

        EnvironmentInfo info = new EnvironmentInfo(xyo, baseState);
    ...
    public void movingState() {
        ...
        EnvironmentInfo fakeInfo = new EnvironmentInfo(xyo, baseState);
