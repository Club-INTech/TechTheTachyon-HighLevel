...
public enum ActuatorsOrder implements Order {
    ...
    ENVOIE_LE_BRAS_DROIT_A_LA_POSITION_ACCELERATEUR_DEPOT_7_PALETS("accMiddle7Depot right"),
    ENVOIE_LE_BRAS_GAUCHE_A_LA_POSITION_ACCELERATEUR_DEPOT_7_PALETS("accMiddle7Depot left"),
