...
public enum ActuatorsOrder implements Order {
    ...
    ENVOIE_LE_BRAS_GAUCHE_A_LA_POSITION_AU_DESSUS_ZONE_DEPART("deposePaletZoneDep left"),
    ENVOIE_LE_BRAS_DROIT_A_LA_POSITION_AU_DESSUS_ZONE_DEPART("deposePaletZoneDep right"),
    ...
    public static final ActuatorsOrder[] ARM_ORDERS = {
            ...
            ENVOIE_LE_BRAS_GAUCHE_A_LA_POSITION_DISTRIBUTEUR_SANS_REESSAI,
            ...
            ENVOIE_LE_BRAS_DU_SECONDAIRE_A_LA_POSITION_ACCELERATEUR2_SECONDAIRE,
            ENVOIE_LE_BRAS_GAUCHE_A_LA_POSITION_AU_DESSUS_ZONE_DEPART,
            ENVOIE_LE_BRAS_DROIT_A_LA_POSITION_AU_DESSUS_ZONE_DEPART,
    };
