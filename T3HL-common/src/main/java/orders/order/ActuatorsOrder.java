...
public enum ActuatorsOrder implements Order {
    ...
    MONTE_ASCENCEUR_DROIT_DE_UN_PALET(/*"up right"*/"ping"),
    MONTE_ASCENCEUR_GAUCHE_DE_UN_PALET(/*"up left"*/ "ping"),
    DESCEND_ASCENSEUR_DROIT_DE_UN_PALET(/*"down right"*/ "ping"),
    DESCEND_ASCENSEUR_GAUCHE_DE_UN_PALET(/*"down left"*/"ping"),
