...
public class MainSlave extends RobotEntryPoint {
    ...
    protected void act() throws UnableToMoveException {
        ...
        Vec2 startPos = new VectCartesian(1500 -297,400);

        XYO.getRobotInstance().update(startPos.getX(), startPos.getY(), Math.PI/2);
        robot.setPositionAndOrientation(startPos, Math.PI/2);
