...
public enum ActuatorsOrder implements Order {
    ...
    ENVOIE_LE_BRAS_DU_SECONDAIRE_A_LA_POSITION_MUSCLOR("musclor"),
    ...
    ENVOIE_LE_BRAS_DU_SECONDAIRE_A_LA_POSITION_GOLDONIUM("gold"),
    ENVOIE_LE_BRAS_DU_SECONDAIRE_A_LA_POSITION_GOLDONIUM_DEPOT("goldDepot"),
